	...
	<div class="contentWrap">
		<div class="leftMenu">
			...
			<ul> 
				...
				<li> <a href="${pageContext.request.contextPath}/admin/adminComment" style="font-weight:bold;"> 시술후기</a></li>
					...
					<c:choose>
					    ...
					    <c:otherwise>
					        <c:forEach var="item" items="${list}">
								<tr>
									<td>${item.bno}</td>
									<td class="title"><a href="adminCommentRead${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${item.bno}">${item.title}</a></td>
									<td>${item.writer}</td>
									<td><fmt:formatDate type="date" value="${item.regdate}"/></td>
									<td>${item.cnt}</td>
									<td>
										<a href="${pageContext.request.contextPath}/admin/adminCommentUpdate${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${item.bno}"><button>수정</button></a>
										<a href="${pageContext.request.contextPath}/admin/adminCommentDelete${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${item.bno}"><button>삭제</button></a>
									</td>
								</tr>	
							</c:forEach>
					    </c:otherwise> 
