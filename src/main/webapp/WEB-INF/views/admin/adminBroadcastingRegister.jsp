...
<body>
	...
	<div class="contentWrap">
		...
		<div class="centerMenu">
			<form id="form1" method="post" action="adminBroadcastingRegister">
				<div id="container">
					<h2>공지사항 글쓰기</h2>
					...
					<div class="btn">
						...
						<a href="${pageContext.request.contextPath}/admin/adminBroadcasting"><button type="button">뒤로가기</button></a>
					</div>
				</div>
			</form>
		</div>
