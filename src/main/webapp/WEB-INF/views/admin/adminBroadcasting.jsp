...
<script type="text/javascript">
	$(function(){
        ...
        $("#searchBtn").click(function(){
    		...
    		location.href="adminBroadcasting${pageMaker.makeQuery(1)}&searchType="+searchType+"&keyword="+keyword;
    	});
	...
	<div class="contentWrap">
		<div class="leftMenu">
			...
			<ul> 
				...
				<li> <a href="${pageContext.request.contextPath}/admin/adminBroadcasting" style="font-weight:bold;"> 언론보도</a></li>
		...
		<div class="centerMenu">
			...
			<div class="tbl_board">
					...
					<c:choose>
					    ...
					    <c:otherwise>
					        <c:forEach var="item" items="${list}">
								<tr>
									<td>${item.bno}</td>
									<td class="title"><a href="adminBroadcastingRead${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${item.bno}">${item.title}</a></td>
									<td>${item.writer}</td>
				...
				<p class="registerBtn"><a href="adminBroadcastingRegister${pageMaker.makeSearch(pageMaker.cri.page)}"><button>글쓰기</button></a></p>
				<div class="page">
					<ul>
