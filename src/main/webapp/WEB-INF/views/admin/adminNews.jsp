	...
	<div class="contentWrap">
		<div class="leftMenu">
			...
			<ul> 
				...
				<li> <a href="${pageContext.request.contextPath}/admin/adminNews" style="font-weight:bold;"> 유한소식</a></li>
				<li> <a href="${pageContext.request.contextPath}/admin/adminAdvice"> 진료/비용 상담</a></li>
			</ul>
		</div>
		<div class="centerMenu"> 
			<h1 class="boardTitle">&lt;유한소식 관리&gt;</h1>
			<div class="tbl_board">
				<table>
					<tr class="tbl_header">
						<th>번호</th>
					...
					<c:choose>
					    ...
					    <c:otherwise>
					        <c:forEach var="item" items="${list}">
								<tr>
									<td>${item.bno}</td>
									<td class="title"><a href="adminNewsRead${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${item.bno}">${item.title}</a></td>
									<td>${item.writer}</td>
