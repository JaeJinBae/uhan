...
<style type="text/css">
	...
	#mainBackground{
		...
		height:25%;
		clear:both;
		background: url("${pageContext.request.contextPath}/resources/images/clinic_top_bg.png") no-repeat;
		position:absolute;
		top:54px;
		left:50%;
...
<body>
	<div id="bodyWrap">
		...
		<div id="mainBackground">
			<div id="mainIntro">
				<h2>진료분야</h2>
				<p>수준높은 의료와 체계적이고 정직한 진료프로그램으로</p>
				<p>환자에게 높은 만족감을 안겨주는 유한통증의학과입니다.</p>
			</div>
		</div>
		<div id="centerNav">
			<ul>
				...
				<li>진료분야&nbsp;&nbsp;&nbsp;&nbsp;<img src="${pageContext.request.contextPath}/resources/images/arrow.png"></li>
				<li>대상포진 클리닉&nbsp;&nbsp;&nbsp;&nbsp;<img src="${pageContext.request.contextPath}/resources/images/arrow.png"></li>
			</ul>
		</div>
		<div id="contentWrap">
