		...
		<div class="mainBackground">
			...
			<div class="navWrap">
				<ul class="navUl"> 
					...
					<li>
						<a href="${pageContext.request.contextPath}/comment">시술후기<img class="btnArrow" src="${pageContext.request.contextPath}/resources/images/down_arrow.png"></a>
						<ul class="sub_subDropdown">
					...
					<c:choose>
					    ...
					    <c:otherwise>
					        <c:forEach var="item" items="${list}">
								<tr>
									<td>${item.bno}</td>
									<td class="title"><a href="${pageContext.request.contextPath}/commentRead${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${item.bno}">${item.title}</a></td>
									<td>${item.writer}</td>
