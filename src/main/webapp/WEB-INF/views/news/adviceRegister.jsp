		...
		<div class="mainBackground">
			...
			<div class="navWrap">
				<ul class="navUl"> 
					...
					<li>
						<a href="${pageContext.request.contextPath}/advice">진료/비용 상담<img class="btnArrow" src="${pageContext.request.contextPath}/resources/images/arrow.png"></a>
						<ul class="sub_subDropdown">
			...
			<div class="registerForm">
				<form id="f1" method="post" action="adviceRegister">
					...
					<div class="btnWrap">
						...
						<a href="${pageContext.request.contextPath}/advice" class="cancelBtn"><button type="button">취소</button></a>
					</div>
				</form>
			</div>
		</div><!-- contentWrap end -->
