	...
	<section>
		<div class="mainBackground">
			...
			<div class="bgText">
				<h1>진료안내</h1>
				<p> 
					생명존중, 최고지향, 나눔지향으로 환자에게<br>
					높은 만족감을 안겨드리는 유한통증의학과입니다.
				</p>
			</div>
			<div class="navWrap">
				<ul class="navUl"> 
					...
					<li>
						<a href="${pageContext.request.contextPath}/intro1">진료안내<img class="btnArrow" src="${pageContext.request.contextPath}/resources/images/down_arrow.png"></a>
					...
					<li>
						<a href="${pageContext.request.contextPath}/intro3">자주하는 질문<img class="btnArrow" src="${pageContext.request.contextPath}/resources/images/down_arrow.png"></a>
						<ul class="sub_subDropdown">
		...
		<div class="contentWrap">
			...
			<ul class="collapsibleWrap">
				...
				<li class="collapsible">
					...
					<p class="content">
						오십견은 관절낭이라는 어깨 관절을 감싸고 있는 부위에 염증이 발생하여 통증이 오며 어깨가 점점 굳어지는 질환입니다.<br>
			        	주사치료와 약물 치료를 병행하여 진행하며 호전이 없는 경우 충격파 치료를 겸하게 됩니다. 그러면 대부분이 회복이 됩니다.<br>
