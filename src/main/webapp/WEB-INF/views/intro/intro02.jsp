...
<body>
	...
	<section>
		<div class="mainBackground">
			...
			<div class="navWrap">
				<ul class="navUl"> 
					...
					<li>
						<a href="${pageContext.request.contextPath}/intro2">진료비용<img class="btnArrow" src="${pageContext.request.contextPath}/resources/images/down_arrow.png"></a>
						<ul class="sub_subDropdown">
		...
		<div class="contentWrap">
			...
			<div class="content">
				<img src="${pageContext.request.contextPath}/resources/images/intro2Img.PNG">
			</div><!-- content end -->
		</div><!-- contentWrap end -->
